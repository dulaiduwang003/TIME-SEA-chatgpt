<template>
  <div class="panel-container">
    <div class="body" v-if="mainPageVisible">
      ...
      <ViewState class="state" v-if="!store.getters.userinfo" Type="error" ErrorText="登录后查看" IsShowBottom ButtonText="登录"
      ...
      <ViewState class="state" v-else-if="error" @ClickTheButton="init" Type="error" ErrorText="加载错误，请重试" IsShowBottom
        ButtonText="重新加载" />
      ...
      <el-dialog v-model="payVisible" title="赞助站点" v-if="productFrequency" style="text-align: center;"
        :show-close="false">
        <div class="pay-title">
          选择支付方式
        </div>
        <div style="text-align: center">
          <el-radio label="0" v-model="payType">
            <div class="pay">
              <img class="alipay-img" alt="支付宝支付" src="../assets/alipay.svg">
              <div>支付宝</div>
            </div>
          </el-radio>
        </div>
