<template>
  <div class="u_container">
    ...
    <el-table :data="dataTables" height="300px"   :header-cell-style="{ background:' rgb(27,30,32)',borderColor:'#202020'}"
      ...
      <el-table-column fixed="right" label="操作" width="200">
        ...
        <template #default="scope">
          <el-button link type="primary" size="small" @click="handleUpdateUserInfo(scope.row)">编辑</el-button>
        </template>
      </el-table-column>
  ...
  <el-dialog v-model="dialogFormVisible" width="400px" x style="background-color: rgb(27,30,32);padding-top: 20px">
    <el-form>
      <el-form-item label="用户昵称" label-width="100px">
        <el-input autocomplete="off" tyle="width: 120px" v-model="form.userName" />
      </el-form-item>
    </el-form>
    <el-form>
      <el-form-item label="Ai币" label-width="100px">
        <el-input autocomplete="off" style="width: 120px" v-model="form.frequency"/>
      </el-form-item>
    </el-form>
    <template #footer>
...
import {GetUserCount, GetUserInfo, GetUserPage, UpdateUserInfo} from "../../../../api/BSideApi";
