<template>
  <div class="u_container">
    <div style="margin-bottom: 30px;margin-top: 30px">
      <el-button color="#626aef" style="width: 100px" @click="dialogFormVisible=true">新增兑换码</el-button>
    </div>
    <el-table :data="dataTables" height="360px"
      ...
      <el-table-column fixed="right" label="操作" width="200">
        ...
        <template #default="scope">
          <el-button link type="primary" size="small" @click="deleteRedemption(scope.row)">删除</el-button>
        </template>
      </el-table-column>
  ...
  <el-dialog v-model="dialogFormVisible" width="400px" x style="background-color: rgb(27,30,32);padding-top: 20px">
    <el-form>
      <el-form-item label="生成数量" label-width="100px">
        <el-input autocomplete="off" tyle="width: 120px" v-model="form.buildQuantity"/>
      </el-form-item>
    </el-form>
    <el-form>
      <el-form-item label="所含Ai币" label-width="100px">
        <el-input autocomplete="off" style="width: 120px" v-model="form.buildFrequency"/>
      </el-form-item>
    </el-form>
    <template #footer>
      <span class="dialog-footer">
        <el-button type="default" color="#626aef" @click="handleAddRedemptionCode">
          生成
        </el-button>
      </span>
    </template>
...
import {AddRedemptionCode, DeleteRedemptionCode, GetRedemptionCodePage} from "../../../../api/BSideApi";
