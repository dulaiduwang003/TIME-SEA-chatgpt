        ...
        >
          <el-form @keyup.enter="onSubmit" ref="formRef" size="large">
            ...
            <el-form-item prop="password">
              ...
              <div
                  style="text-align: right; color: #929292; font-size: 10px;display: flex;"
    ...
    >
      <div class="login-box">
        <div style="display: flex;justify-content: center;align-items: center;padding-top: 40px">
          <img src="../assets/logoHead.svg" style="width: 60px;height: 60px" alt=""/>
        </div>
        <div style="padding: 20px 40px 30px;">
          ...
          <el-form @keyup.enter="retrievePassword" ref="formRef" size="large">
            ...
            <el-form-item prop="code">
              ...
              <div style="text-align: right; color: #929292; font-size: 10px;" @click="backLoginPanel">
                返回登录
              </div>
            </el-form-item>
            <el-form-item>
